...
static bool checkDeviceFeatures(const char* label, bool bExtension, std::uint32_t availableCount, void *available,
                                std::uint32_t requestedCount, const DeviceFeature *requestFeatures,
                                std::uint32_t *outEnableCount, const char *outEnableFeatures[]){
...
static void check_vk_result(VkResult result, const char *fileName, std::uint32_t line, const char* func){
